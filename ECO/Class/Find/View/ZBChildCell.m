...
- (void)refreshUI:(ZBProductDataModel *)model{
    ...
    [self.imageHeadView sd_setImageWithURL:[NSURL URLWithString:model.model_banner_url?:model.brand_banner_url] placeholderImage:[UIImage imageNamed:@"placeholder"]];
