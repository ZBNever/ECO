...
@interface ZBMacBookViewController ()
...
@implementation ZBMacBookViewController
...
//    NSArray *urlArr = @[iphone_URL,android_URL,ipad_URL,macbook_URL,watch_URL];
    ...
    [ZBHTTPRequestManager requestGETWithURLStr:macbook_URL paramDic:nil Api_key:nil finish:^(id responseObject) {
