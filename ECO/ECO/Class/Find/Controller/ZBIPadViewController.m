...
@interface ZBIPadViewController ()
@property (nonatomic, weak) RequesCover *cover;

@property (nonatomic, strong) NSMutableArray *dataArr;
@end

@implementation ZBIPadViewController
...
//    NSArray *urlArr = @[iphone_URL,android_URL,ipad_URL,macbook_URL,watch_URL];
    ...
    [ZBHTTPRequestManager requestGETWithURLStr:ipad_URL paramDic:nil Api_key:nil finish:^(id responseObject) {
